...
// resultError.
func (e ErrorStatuses) To(resultError error, decoder Decoder) Option {
...
// resultError.
func (e ErrorStatuses) ToJSON(resultError error) Option {
...
// resultError.
func (e ErrorStatuses) ToXML(resultError error) Option {
